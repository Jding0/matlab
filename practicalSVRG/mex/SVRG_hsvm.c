...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs < 8)
        mexErrMsgTxt("Function needs at least eight arguments: {w,Xt,y,lambda,alpha,iVals,d,wOld[,covered,oldZero]}");
